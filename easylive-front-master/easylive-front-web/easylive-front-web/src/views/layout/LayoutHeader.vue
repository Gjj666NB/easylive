<template>
  <div :class="['header-bar', 'header-bar-' + theme]">
          ...
          <div class="nav-part" v-for="index in categoryPartCount">
            <router-link
              ...
              v-for="item in categoryStore.categoryList.slice(
                (index - 1) * proxy.colCategoryCount,
                index * proxy.colCategoryCount
              )"
    ...
    <div class="user-panel">
      ...
      <div class="upload-btn" @click="navJump(`/ucenter/postVideo`)">
...
const categoryPartCount = computed(() => {
  return Math.ceil(categoryStore.categoryList.length / proxy.colCategoryCount);
});
